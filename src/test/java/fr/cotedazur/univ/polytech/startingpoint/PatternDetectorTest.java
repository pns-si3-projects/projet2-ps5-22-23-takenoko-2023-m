...
class PatternDetectorTest {
    ...
    void detectLINEPatternNearHorizontal() {
        board.addTile(new Tile(new Coordinate(2,0),TypeOfTile.RED, TypeOfArrangement.NONE));
        assertEquals(0,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(3,0),TypeOfTile.RED, TypeOfArrangement.NONE));
        assertEquals(1,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(4,0),TypeOfTile.GREEN, TypeOfArrangement.NONE));
        assertEquals(1,board.patternDetector.getPatternBoardList().size());
    }
    @Test
    ...
    void detectLINEPatternNearDiagonal() {
        ...
        assertEquals(0,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(1,-2),TypeOfTile.RED, TypeOfArrangement.NONE));
        assertEquals(1,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(1,-3),TypeOfTile.GREEN, TypeOfArrangement.NONE));
        assertEquals(1,board.patternDetector.getPatternBoardList().size());
    }
    @Test
    void detectTRIANGLEPatternNear() {
        board.addTile(new Tile(new Coordinate(2,-1),TypeOfTile.RED, TypeOfArrangement.NONE));
        assertEquals(0,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(2,-0),TypeOfTile.RED, TypeOfArrangement.NONE));
        System.out.println(board.patternDetector.getPatternBoardList());
    ...
    void detectBOOMRANGPatternNear() {
        ...
        assertEquals(0,board.patternDetector.getPatternBoardList().size());
        board.addTile(new Tile(new Coordinate(0,2),TypeOfTile.RED, TypeOfArrangement.NONE));
    ...
    void bestCoordinateForTriangle() {
        board.addTile(new Tile(new Coordinate(1,-1),TypeOfTile.GREEN, TypeOfArrangement.NONE));
        board.addTile(new Tile(new Coordinate(2,-1),TypeOfTile.GREEN, TypeOfArrangement.NONE));
    ...
    void bestCoordinateForBoomrang() {
        ...
        board.addTile(new Tile(new Coordinate(-3,1),TypeOfTile.GREEN, TypeOfArrangement.NONE));
